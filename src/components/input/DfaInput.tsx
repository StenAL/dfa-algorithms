...
export default function DfaInput({convertInputCallback}: DfaInputProps) {
    ...
    return (<div className={"dfa-input"}>
        <div className={"input-fields"}>
            <label htmlFor={"states"}>States</label>
            <input name={"states"} type={"text"} placeholder={"q1,q2..."} onChange={(event) => {
            ...
            <input name={"alphabet"} type={"text"} placeholder={"0,1,..."} onChange={(event) => {
            ...
            <input name={"finalStates"} type={"text"} placeholder={"q1,..."} onChange={(event) => {
