    ...
    return (
        <>
            <Route path={"/table-filling/input"}>
                ...
                <Switch checked={mode === Mode.MINIMIZATION} onChange={() => { mode === Mode.EQUIVALENCE_TESTING ? setMode(Mode.MINIMIZATION) : setMode(Mode.EQUIVALENCE_TESTING)}}
                checkedIcon={false} uncheckedIcon={false} offHandleColor={"#95E2FF"} onHandleColor={'#95E2FF'} offColor={"#888"} onColor={"#888"} width={75}/>
                ...
                <Link className={"disabled-link"} to={"/table-filling/algorithm"}><button disabled={!inputValid}>Run</button></Link>
